<title>Penyakit - Certainty Factor V.2</title>
...
if (!(isset($_SESSION['username']) && isset($_SESSION['password']))) {
  ...
  switch ($_GET['act']) {
    ...
    if ($_POST['Go']) {
      ...
      <tr><td width=120>Pengendalian</td><td><textarea rows='4' cols='50' class='form-control' name='srn_penyakit'type=text placeholder='Masukkan Pengendalian baru...'></textarea></td></tr>
      ...
      <tr><td width=120>Pengendalian</td><td><textarea rows='4' cols='50' type=text class='form-control' name='srn_penyakit'>$r[srn_penyakit]</textarea></td></tr>
