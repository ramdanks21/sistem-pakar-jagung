            ...
            if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
              ...
              <li class="dropdown user user-menu">
                ...
                <li class="user-footer"> 
                  <div class="pull-left">
                    <a class="btn btn-default btn-flat" <?php if ($module == "tentang") echo 'class="class="btn btn-default btn-flat active"'; ?> href="tentang"><i class="fa fa-info-circle"></i> <span>Tentang</span></a>
                  </div>
  ...
  <aside class="main-sidebar">
    ...
    <footer class="main-footer">
      ...
      <button class="kontak ke-kanan" data-toggle="modal" data-target="#modalForm">
        ...
        <strong><div class="cinta">©2020 - Developed with <i class="fa fa-heart pulse"></i> by <a href="http://www.mycoding.net" target="_blank">My Coding</a></div></strong>
      </footer>
